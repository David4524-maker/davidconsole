...
# -*- coding: utf-8 -*-
"""
davidconsole v1.2 CLI — 151 comandos multi-idioma en la terminal.
Versión de línea de comandos (CMD, PowerShell, Terminal, bash…).
Comando especial: url: https://... abre el navegador.
...
# ============================================================
# COLORES ANSI (funcionan en Windows 10+, macOS y Linux)
# ============================================================
if os.name == "nt":
    os.system("")  # habilita secuencias ANSI en CMD moderno
...
T = {
 "es": {"bienvenida": "/davidconsole 1.2 CLI/ escribe \"ayuda\" para ver todos los comandos disponibles",
        ...
        "sobre": "davidconsole v1.2 CLI — Terminal de 151 comandos multi-idioma. Hecho en Python.",
 ...
 "en": {"bienvenida": "/davidconsole 1.2 CLI/ type \"help\" to see all available commands",
        ...
        "sobre": "davidconsole v1.2 CLI — 151-command multi-language terminal. Made in Python.",
 ...
 "fr": {"bienvenida": "/davidconsole 1.2 CLI/ tapez \"aide\" pour voir toutes les commandes",
        ...
        "sobre": "davidconsole v1.2 CLI — Terminal multi-langue de 151 commandes. Fait en Python.",
 ...
 "de": {"bienvenida": "/davidconsole 1.2 CLI/ tippe \"hilfe\" für alle Befehle",
        ...
        "sobre": "davidconsole v1.2 CLI — 151-Befehl Multi-Sprache Terminal. In Python gemacht.",
 ...
 "pt": {"bienvenida": "/davidconsole 1.2 CLI/ digite \"ajuda\" para ver todos os comandos",
        ...
        "sobre": "davidconsole v1.2 CLI — Terminal multi-idioma de 151 comandos. Feito em Python.",
        "quien": "Sou davidconsole, um terminal criado por David em Python. 151 comandos em 6 idiomas.",
        "url_abriendo": "🌐 Abrindo: {url}",
        "url_invalida": "URL inválida: {url}"},
 "it": {"bienvenida": "/davidconsole 1.2 CLI/ digita \"aiuto\" per tutti i comandi",
        ...
        "sobre": "davidconsole v1.2 CLI — Terminal multi-lingua da 151 comandi. Fatto in Python.",
...
def c_ayuda(a):
    print(f"{GREEN}{t('ayuda_titulo', n=len(COMANDOS))}{RESET}")
    for k in sorted(COMANDOS):
        nm = nombre_actual(k)
        d = COMANDOS[k]["desc"].get(STATE["lang"]) or COMANDOS[k]["desc"].get("es", "")
        print(f"  {CYAN}{nm:<22}{RESET} {GRAY}{d}{RESET}")
...
def c_version(a): print(f"davidconsole 1.2 CLI — Python {sys.version.split()[0]}")
...
def c_idiomas(a):
    for k, v in IDIOMAS.items(): print(f"  {CYAN}{k}{RESET}  {v}")
...
# ============================================================
def show_banner():
    """Dibuja el banner tipo terminal."""
    ...
    print(f"{WHITE}{BOLD}    ╚═════╝ ╚═╝  ╚═╝  ╚═══╝  ╚═╝╚═════╝ {RESET}")
    print(f"{WHITE}              {CYAN}console{RESET}  {GRAY}v1.2 CLI{RESET}")
    print(f"{GREEN}{'═' * 62}{RESET}")
    print(f"{GRAY}                Hecho en Python 🐍{RESET}")
    print()
...
def execute(linea):
    ...
    if canonical is None:
        print(f"{RED}{t('desconocido', cmd=nombre)}{RESET}")
        return
    try:
...
def main():
    ...
    print(f"{GRAY}Total de comandos registrados: {len(COMANDOS)}{RESET}")
    print(f"{GRAY}Idioma actual: {IDIOMAS[STATE['lang']]}  |  Escribe '{nombre_actual('idioma')} en' para cambiar.{RESET}")
    print()

    while STATE["running"]:
        # Prompt con color: [es] >
        prompt = f"{ORANGE}[{STATE['lang']}]{RESET} {WHITE}>{RESET} "
        try:
            linea = input(prompt)
